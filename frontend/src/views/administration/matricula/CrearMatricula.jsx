...
import DatosPersonales from "../docentes/DatosPersonalesComponent";

import AsignaturasCursos from "../docentes/AsignaturasCursosComponent";
    ...
    <PageContainer title="Profile" description="User profile">
      <Grid container>
        ...
        <Grid item xs={12} pl={3} mb={2}>
          <Typography variant="h3">Crear Matrícula</Typography>
        </Grid>
